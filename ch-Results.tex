...
hydrostatic equilibrium eaution holds

and since the pressur is so low we don ont obatin mor infoatmion higher up
...
\section{Posterior Ozone distributions with Linear model}
\begin{itemize}
...
\subsubsection{Sampling from the marginal posterior distribution over hyper-parameters}
...
\section{Generate and Asses Affine Map} 
\label{sec:affineMap}
\begin{itemize}
...
\subsection{Updated Forward map}
...
\section{Posterior Ozone with approximated Forward map}
\subsection{Second MTC -  Ozoen with Approximated Forward map}
\begin{itemize}
