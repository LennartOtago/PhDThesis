...
We observe that the larger eigenvalues of $\bm{Q}_{ \bm{x}|\delta, \gamma,\bm{y}}$ are very much the same as the larger eigenvalues of $\bm{A}^T \bm{A}$.
Once the eigenvalues of $\bm{A}^T \bm{A}$ are significantly smaller the structure of the eigenvalues of $\bm{Q}_{ \bm{x}|\delta, \gamma,\bm{y}}$ is dominated by the structure of the eigenvalues of $\delta \bm{L}$.
Note that the eigenvalues correspond to different eigenspaces spanned by the corresponding eigenvectors which may differ.
The largest 10 eigenvalues of $\bm{Q}_{ \bm{x}|\delta, \gamma,\bm{y}}$ to ozone profile structure in lower altitudes, where as the other eigenvalues correspond mainly to structures mainly in higher altitudes see \ref{fig:}.
