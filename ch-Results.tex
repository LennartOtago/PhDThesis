...
Then one would iteratively proceed until convergence, which we will not show here since we focus on the underlying Bayesian framework and methods to obtain posterior distributions of either one.
...
we reduce x to from 45 to $34$ by taken every second value over $\approx47$km
...
\subsection{Pressure and Temperature Ratio conditioned on Noise and Ozone}
