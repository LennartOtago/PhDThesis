...
This results in posterior pressure values which are slightly larger than the ground truth, resulting in posterior ozone profiles with a similar structure but much smaller peak values, compared to the ground truth.
Because of this, the ozone profiles are smoother and hence $\lambda$ values are larger (see Fig.\ref{fig:PostHistTT0}).
