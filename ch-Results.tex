...
\begin{figure}[thb!]
	...
	\end{tikzpicture} 
\caption[Directed acyclic Graph for pressure and temperature.]{Hyper-paremers poster posterior distribution in Eq. \ref{eq:} Note that here we use the updated forward model $\bm{M} \bm{A}_L$ }
	\label{fig:DAGPT}
\end{figure}
