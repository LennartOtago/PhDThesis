...
\subsection{Eigenvectors of Full Conditional Posterior Precision Matrix}
 \begin{figure}[ht!]
 	...
 	\caption[First 12 eigenvectors of conditional precision matrix.]{First 12 eigenvectors corresponding to in size ordered eigenvalues of conditional precision matrix $\bm{Q}_{ \bm{x}|\delta, \gamma, \bm{y}}$.
 ...
 \begin{figure}[ht!]
 	...
 	\caption[Last 22 eigenvectors of conditional precision matrix.]{Last 22 eigenvectors corresponding to in size ordered eigenvalues of conditional precision matrix $\bm{Q}_{ \bm{x}|\delta, \gamma, \bm{y}}$. The eigenvectors represent structures mainly above $30$km.}
