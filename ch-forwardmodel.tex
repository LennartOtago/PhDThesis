...
\begin{itemize}
	\item[{\includegraphics[height=0.65\baselineskip]{CASE1.png}}] \textbf{Case 1} includes 42 measurements between heights of $\approx7$km and $\approx83$km with pointing angles
	\begin{align*} 
...
\begin{figure}[ht!]
	...
	The corresponding tangent heights of the test cases are plotted in Fig.~\ref{fig:TangHCases}. The dotted horizontal line marks an SNR according to $\sigma_1$ of measurement case 5.}
\label{fig:SingA}
\end{figure}
...
\mccorrect{Cases 3, 4, and 5 with equidistantly spaced pointing angles have similar effective ranks, and their singular values decrease more slowly compared to cases 1 and 2. Although case 4 uses twice as many measurements as case 3, the additional measurements provide only limited additional information, as reflected by the similar effective ranks and singular value behaviour. Consequently, the additional engineering effort required to achieve the higher pointing accuracy is not justified by the comparatively small increase in information provided by the forward model. Similarly, the slightly lower pointing accuracy in case 5 compared to case 3 still provides a comparable effective rank and therefore a similar amount of usable information.
}
The last 5 to 10 singular values of case 3 are so small that the associated information will be lost due to the noise.
...
\mccorrect{In principle, this demonstrates that the measurement strategy influences the information of the observations. However, simply increasing the number of measurements in high-signal or low-signal regions does not necessarily provide more information.}
