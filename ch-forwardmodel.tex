...
\begin{itemize}
	\item \textbf{case 1} equidistance measurements between $h_{L,1} = 7$km and $h_{L,1} = 35$km with pointing accuracy 0.18
	\item \textbf{case 2} equidistance measurements pointing accuracy
	\item \textbf{case 3} equidistance measurements pointing accuracy
	\item \textbf{case 4} equidistance measurements pointing accuracy
	\item \textbf{case 5} equidistance measurements pointing accuracy
\end{itemize} 
