...
\begin{figure}[ht!]
	...
	The corresponding tangent heights of the different cases are plotted in Fig. \ref{fig:TangHCases}.}
	\label{fig:SingA}
\end{figure}
...
\begin{figure}[ht!]
	...
	\caption[Left singular vectors of forward model matrix for one sequence of measurements.]{We plot the first 20 left singular vectors of forward model matrix for case 5 sequence of measurements, see Fig. \ref{fig:SingA}. We include an approximate for the disiered Signal to noise ratio if $s_1 \approx max(\bm{y}) $ the signal.}
	\label{fig:SingVecA}
\end{figure}
...
\begin{figure}[ht!]
	\centering
	\includegraphics{SingVecA.png}
	\caption[Singular vectors of forward model matrix for one sequence of measurements.]{We plot the first 20 singular vectors of forward model matrix for case 5 sequence of measurements, see Fig. \ref{fig:SingA}. To display the image space..}
	\label{fig:}
\end{figure}
