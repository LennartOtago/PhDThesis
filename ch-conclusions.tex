...
\begin{mccorrection}
	Furthermore, introducing additional model-describing hyper-parameters increases the uncertainty of the posterior estimate of ozone (see Fig.~\ref{fig:O3Post} compared to Fig.~\ref{fig:O3Samp} and Fig.~\ref{fig:O3SolplsReg}). This is because the model accounts for uncertainties in a larger number of interacting quantities. While this leads to broader posterior distribution for ozone, it also reduces the risk of overconfident estimates by explicitly accounting for these additional sources of uncertainty and reveals dependencies that would otherwise remain hidden.
\end{mccorrection}
