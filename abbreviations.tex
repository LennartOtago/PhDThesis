...
\DTLnewrow{abbr}\DTLnewdbentry{abbr}{label}{IATC}\DTLnewdbentry{abbr}{desc}{Integrated Autocorrelation Time}
...
%\DTLnewrow{abbr}\DTLnewdbentry{abbr}{label}{RTO}\DTLnewdbentry{abbr}{desc}{Randomise Than Optimise}
% sort by label
\DTLsort{label}{abbr}
