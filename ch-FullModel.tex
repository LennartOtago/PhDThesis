...
\begin{itemize}
	\item \includegraphics[height=0.6\baselineskip]{SIRTMH.png} \textbf{rel. expect Err. (SIRT-MH)} 
	\begin{align*} 
		\frac{\lVert\bm{\mu}_{\text{SIRT-MH}} - \bm{\mu}_{\text{t-walk}} \rVert_{L^2}}{  \lVert \bm{\mu}_{\text{t-walk}} \rVert_{L^2} }
	\end{align*}
	\item  \includegraphics[height=0.6\baselineskip]{QUAD.png} \textbf{rel. expect Err. (quadrature)}
	\begin{align*} 
		\frac{\lVert\bm{\mu}_{\text{TT}} - \bm{\mu}_{\text{t-walk}} \rVert_{L^2} }{ \lVert \bm{\mu}_{\text{t-walk}} \rVert_{L^2} }
	\end{align*}
	\item  \includegraphics[height=0.6\baselineskip]{RMS.png} \textbf{rel. RMS Error} 
	\begin{align*} 
				\frac{\lVert \tilde{\pi}  - \pi \rVert_{L^2} }{ \lVert \pi \rVert_{L^2} }
	\end{align*}
	\item  \includegraphics[height=0.6\baselineskip]{W1.png} \textbf{Wasserstein Distance}
	\begin{align*} 
