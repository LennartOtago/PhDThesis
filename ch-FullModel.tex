\chapter{Hierarchical Bayesian Model -- Ozone, Pressure, Temperature }
\label{ch:FullBay}
\begin{figure}[thb!]
	\centering
	\begin{tikzpicture}
...
\section{Marginal Posterior distribution}
...
\subsection{Sampling from marginal posterior}
...
\subsection{TT Approximation of marginal posterior}
...
\subsubsection{Find optimal rank and grid size}
...
\section{Full conditional posterior distribution}
