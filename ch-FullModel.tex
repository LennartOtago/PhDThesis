...
\label{ch:FullBay}
Here, the hierarchical Bayesian model in Sec. \ref{sec:BayModelO3} and the MTC scheme is extended to jointly provide posterior distributions of ozone ,pressure and  temperature.
We elaborate on some aspects of prior modelling.
Additionaly we guide the reader through the process of approximating the  higher-dimensional marginal posterior more efficiently using a TT.
...
\section{Hierarchical Bayesian Model -- Ozone, Pressure, Temperature }
\begin{figure}[thb!]
	\centering
	\begin{tikzpicture}
...
\subsection{Marginal Posterior Distribution -- Pressure and Temperature}
...
\subsection{Full Conditional Posterior Distribution -- Ozone}
