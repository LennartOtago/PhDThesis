...
Errors are provided based on a local derivative of the forward map at one optimal solution, which is inherently highly sensitive to that specific point in the parameter space.
