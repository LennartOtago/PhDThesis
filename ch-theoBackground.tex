...
We calculate the IACT using the Python implementation of \cite{WOLFF2004143}, accesed \cite{wolff2004monte}, which also provides errors on the IACT, which helps us to assess convergence of the chain.
