...
So every solution $\bm{x}_{\lambda}$ is extremely regularised for a given data misfit and the L-curve presents the lower boundary to an open set of high-dimensional posterior samples~\cite{VowelsMultiD}.
