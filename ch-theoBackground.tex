...
%A map $P : \mathcal{F} \longrightarrow \mathbb{R}$ is a probability measure if $\mathbb{P}(\Omega) = 1$ for an event $A \subseteq  \Omega$ $\mathbb{P}(A) \in [0,1] $ and $\mathbb{P}(\emptyset) = 0$.
\begin{align}
