...
Then a solution $\bm{x}_{\lambda}  = \underset{\bm{x}}{\text{arg min }}\bm{x}^T \bm{L} \bm{x}$ minimises the squared regularisation norm with respect to constant $\left\lVert \bm{y} - \bm{A} \bm{x} \right\rVert^2_{L^2}$ (see~\cite[fn. 6]{fox2016fast} and~\cite[Fig. 2.13]{SANTOSH202265}). 
