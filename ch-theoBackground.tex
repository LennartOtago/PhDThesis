...
\begin{mccorrection}
The factorisation underlying the MTC framework is not restricted to the later introduced linear-Gaussian setting. Eq.~\ref{eq:margGen} holds more generally for hierarchical Bayesian models \cite[Lemma 2]{fox2016fast, norton2018sampling}.
...
\begin{mccorrection} 
Further, the Wasserstein distance measures the discrepancy between the distribution due to the TT approximation and the exact distribution.
