...
\title{Hierarchical Bayesian Modelling and Posterior Inference Applied to Limb-Sounding of Atmospheric Ozone}
%Hierarchical Bayesian Modelling and Posterior Inference Applied to an Atmospheric Limb-Sounder Measuring Ozone
...
%	\input{abstract} % Create an abstract.tex file in the 'text' folder for your abstract.
...
%\the\paperheight\\
\include{ch1-intro}
\include{ch-theoBackground}
\include{ch-forwardmodel}
%\include{ch-LinVsReg}
%\include{ch-Affine}
\include{ch-MyLinVsReg}
\include{ch-MyAffine}
\include{ch-FullModel}
%\include{ch-Results}
\include{ch-conclusions}
%\include{ch2_hierarchModel}
%\include{ch3-application}
%\include{ch3_NonLinModel}
%\include{outline}
%% APPENDICES %% 
